...
const Content3 = () => {
  ...
  return (
    ...
    <div className="singleContent3Details bg-customBlue rounded-lg p-4 my-2 mx-6">
        ...
        <div className="singleContent3Details bg-white border border-gray-200 rounded-lg shadow-md mx-6">
          {/* <div>
