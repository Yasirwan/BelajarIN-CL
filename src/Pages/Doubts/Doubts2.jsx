...
import { createDoubt2, getDoubt2Data } from "../../Redux/doubt/action2";
...
const Doubts2 = () => {
  ...
  const { doubt2, load } = useSelector((store) => store.doubt2);
  ...
  const handleSubmit = () => {
    ...
    console.log(obj);
    setLoading(true);
    dispatch(createDoubt2(obj)).then((res) => {
      if (res.msg == "Error") {
        setLoading(false);
        messageApi.open({
          type: "info",
