...
import { createScratch2, getScratch2Data } from "../../Redux/scratch/action2";
...
const Scratchs2 = () => {
  ...
  const { scratch2, load } = useSelector((store) => store.scratch2);
  ...
  const submitScratch2 = () => {
    ...
    console.log(obj);
    setLoading(true);
    dispatch(createScratch2(obj)).then((res) => {
      if (res.msg == "Error") {
        setLoading(false);
        messageApi.open({
          type: "info",
...
<div className="scratchResponses border-solid border-2 border-customBlue">
        ...
        <div class="mx-auto w-full max-w-screen-xl">
          <div class="relative" style={{ paddingTop: "75%" }}>
            <iframe src="https://quizizz.com/join?gc=86789636" allowtransparency="true" className="absolute inset-0 w-full h-full" frameBorder="0" scrolling="yes" allowFullScreen></iframe>
          </div>
        </div>
        ...
        >
          <form>
            ...
            />
            <input
              placeholder="Scratch2 Thumbnail"
              type="url"
              name="thumbnail"
          ...
          <br></br> */}
          <button className="Submit" onClick={() => submitScratch2()}>
            Add Scratch2
          </button>
