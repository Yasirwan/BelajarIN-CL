...
import { createScratch3, getScratch3Data } from "../../Redux/scratch/action3";
...
const Scratchs3 = () => {
  ...
  const { scratch3, load } = useSelector((store) => store.scratch3);
  ...
  const submitScratch3 = () => {
    ...
    console.log(obj);
    setLoading(true);
    dispatch(createScratch3(obj)).then((res) => {
      if (res.msg == "Error") {
        setLoading(false);
        messageApi.open({
          type: "info",
...
<div className="scratch3Responses bg-customBlue rounded-lg p-4 my-2 mx-6">
        ...
        >
          <form>
            ...
            />
            <input
              placeholder="Scratch3 Thumbnail"
              type="url"
              name="thumbnail"
          ...
          <br></br> */}
          <button className="Submit" onClick={() => submitScratch3()}>
            Add Scratch3
          </button>
